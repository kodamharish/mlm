    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('looking_to', models.CharField(choices=[('sell', 'Sell'), ('rent', 'Rent / Lease'), ('pg', 'PG')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='property.property')),
            ],
        ),
    ]
